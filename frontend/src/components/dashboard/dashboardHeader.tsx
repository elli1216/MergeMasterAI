  ...
  return (
    <header className="flex flex-col xl:flex-row items-start xl:items-center justify-between border-b border-zinc-800 pb-6 gap-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center w-full xl:w-auto">
        ...
        {/* User Badge */}
        <div className="flex items-center gap-3 bg-zinc-950 p-2 border border-zinc-800 flex-1 sm:flex-none sm:min-w-[200px]">
          {avatarUrl ? (
            <img src={avatarUrl} alt="Avatar" className="w-10 h-10 rounded-none border border-zinc-700 shrink-0" />
          ) : (
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="flex flex-col flex-1">
            ...
            >
              ...
              <span className="font-mono text-xs uppercase tracking-widest">{syncing ? 'SYNCING...' : 'SYNC GITHUB'}</span>
            </Button>
          </div>

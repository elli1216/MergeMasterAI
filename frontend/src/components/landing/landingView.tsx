...
export function LandingView({ onSignIn, onSignUp }: LandingViewProps) {
  const [activeTab, setActiveTab] = useState<
    'remediation' | 'copilot' | 'tests' | 'routing'
  >('remediation')
  ...
  const requestLaunch = (authFn?: () => void) => {
    setPendingAuth(() => authFn || handleAuth)
    setTermsOpen(true)
  }
    ...
    <div className="min-h-screen bg-black text-zinc-50 font-sans selection:bg-white selection:text-black flex flex-col">
      ...
      <div className="bg-zinc-950 border-b border-zinc-800/80 px-4 py-2 text-center text-xs font-mono flex items-center justify-center gap-2 text-zinc-400">
        <span className="inline-flex items-center gap-1 text-emerald-400 font-bold bg-emerald-950/60 border border-emerald-800/60 px-2 py-0.5 text-[10px] uppercase tracking-wider">
          ...
          <p className="text-nowrap">IBM AI Builders Challenge</p>
        </span>
        <span className="hidden sm:inline text-zinc-500">//</span>
        <span className="text-zinc-300 flex">
          Wild Card Category
          <p className="hidden md:flex">
            : Autonomous Developer Productivity & Release Governance
          </p>
        </span>
      </div>
      ...
      <header className="sticky top-0 z-50 bg-black/90 backdrop-blur-md border-b border-zinc-900 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img
            src="/mergemaster.png"
            alt="MergeMaster Logo"
            className="w-8 h-8 rounded-none border border-zinc-700 shadow-md"
          />
          <div className="flex flex-col">
            <span className="font-extrabold tracking-widest text-white uppercase text-base">
              MergeMaster
            </span>
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={() => requestLaunch(onSignIn)}
            className="bg-white text-black px-2 py-1 md:px-5 md:py-2.5 text-xs font-mono uppercase tracking-widest font-bold hover:bg-zinc-200 transition-all border border-white"
          >
            Launch Console
          </button>
        </div>
      ...
      <section className="relative pt-16 pb-20 md:pt-24 md:pb-28 px-6 max-w-6xl mx-auto text-center space-y-8">
        ...
        <p className="text-zinc-400 font-mono text-sm sm:text-base max-w-3xl mx-auto leading-relaxed">
          MergeMaster AI evaluates pull requests in real time, autonomously
          pushes surgical remediation commits for critical vulnerabilities,
          synthesizes unit tests, enforces organizational policies, and routes
          domain-expert reviewers.
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <button
            onClick={() => requestLaunch(handleAuth)}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-12 border-t border-zinc-900 text-left">
          <div className="p-4 bg-zinc-950/60 border border-zinc-900">
            ...
            <div className="text-[11px] font-mono text-zinc-500 uppercase mt-1">
      ...
      <section
        id="simulation"
        className="py-16 px-6 bg-zinc-950/80 border-y border-zinc-900"
      >
              ...
              <div className="space-y-4 animate-in fade-in duration-300">
                ...
                <div className="bg-zinc-950 p-4 border border-zinc-900 space-y-2">
                  <p className="text-zinc-500">
                    // Detected vulnerable hardcoded secret in
                    src/auth/token.ts:
                  </p>
                ...
                <div className="flex items-center gap-2 text-emerald-400 bg-emerald-950/20 p-3 border border-emerald-900/40">
                  ...
                  <span>
                    <strong>Autonomous Action:</strong> Committer Agent pushed
                    commit <code>a8f4c12</code> directly to{' '}
                    <code>feat/auth-expiry</code> branch.
                  </span>
                </div>
              </div>
            )}
              ...
              <div className="space-y-4 animate-in fade-in duration-300">
                <div className="flex items-center justify-between pb-3 border-b border-zinc-800 text-zinc-400">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-bold">
                      Interactive PR Copilot Session
                    </span>
                  </div>
                  <span className="text-zinc-500 text-[10px]">
                    POST /api/chat
                ...
                <div className="space-y-3">
                  <div className="bg-zinc-900/50 p-3 border border-zinc-800 text-zinc-300">
                    ...
                    "Why was this pull request flagged for medium SQL risk in
                    user_service.py?"
                  </div>
                  <div className="bg-zinc-950 p-3 border border-blue-900/40 text-blue-200">
                    <span className="text-blue-400 uppercase text-[10px] block mb-1">
                      MergeMaster Copilot:
                    </span>
                    "Line 48 concatenates <code>user_id</code> directly into raw
                    query string. Replace with parameterized SQL placeholders
                    (e.g. <code>db.execute(..., (user_id,))</code>) to comply
                    with organizational policy{' '}
                    <strong>#POL-02 (SQL Sanitation)</strong>."
                  </div>
                </div>
              </div>
            )}
...
describe('Auth Validation Suite (Synthesized by MergeMaster)', () => {
  ...
  it('should sanitize SQL injection characters from username input', () => {
    ...
    expect(clean).not.toContain("'")
              ...
              <div className="space-y-4 animate-in fade-in duration-300">
                <div className="flex items-center justify-between pb-3 border-b border-zinc-800 text-zinc-400">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-bold">
                      GitHub Commit Status Gate & Reviewer Routing
                    </span>
                  </div>
                  <span className="text-zinc-500 text-[10px]">
                    PyGithub API
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 bg-zinc-950 border border-zinc-900 space-y-2">
                    ...
                    <p className="text-zinc-500 text-[10px]">
                      Risk Score: 12% // Policy Compliant
                    </p>
                  </div>
      ...
      <section
        id="features"
        className="py-20 px-6 max-w-6xl mx-auto space-y-12"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="p-6 bg-zinc-950 border border-zinc-900 hover:border-zinc-700 transition-all space-y-4">
            ...
            <p className="text-zinc-400 font-mono text-xs leading-relaxed">
              When high-risk vulnerabilities are found, the Committer Agent
              crafts surgical patches and commits them directly to the PR branch
              via PyGithub.
            </p>
          </div>
          ...
          <div className="p-6 bg-zinc-950 border border-zinc-900 hover:border-zinc-700 transition-all space-y-4">
            ...
            <p className="text-zinc-400 font-mono text-xs leading-relaxed">
              Developers can chat with the PR Copilot to inspect security
              findings, understand architectural risks, and receive immediate
              code advice.
            </p>
          </div>
          ...
          <div className="p-6 bg-zinc-950 border border-zinc-900 hover:border-zinc-700 transition-all space-y-4">
            ...
            <p className="text-zinc-400 font-mono text-xs leading-relaxed">
              Automatically creates comprehensive test suites (PyTest, Jest,
              Vitest) covering edge cases and exception branches with a 1-click
              commit pusher.
            </p>
          </div>
          ...
          <div className="p-6 bg-zinc-950 border border-zinc-900 hover:border-zinc-700 transition-all space-y-4">
            ...
            <p className="text-zinc-400 font-mono text-xs leading-relaxed">
              Enforce enterprise security and style guidelines dynamically.
              Custom organizational rules are injected into every automated PR
              diff analysis.
            </p>
          </div>
          ...
          <div className="p-6 bg-zinc-950 border border-zinc-900 hover:border-zinc-700 transition-all space-y-4">
            ...
            <p className="text-zinc-400 font-mono text-xs leading-relaxed">
              Eliminate alert fatigue. Map file patterns like <code>*.sql</code>
              , <code>schema.prisma</code>, or <code>src/auth/*</code> to
              designated specialist reviewers.
            </p>
          </div>
          ...
          <div className="p-6 bg-zinc-950 border border-zinc-900 hover:border-zinc-700 transition-all space-y-4">
            ...
            <p className="text-zinc-400 font-mono text-xs leading-relaxed">
              Track real-time hours saved across all monitored repositories,
              review risk distribution brackets, and audit automated gate
              decisions.
            </p>
          </div>
        </div>
      ...
      <section
        id="architecture"
        className="py-20 px-6 bg-zinc-950 border-t border-zinc-900"
      >
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="p-6 bg-black border border-zinc-800 space-y-3 relative">
              <div className="text-zinc-600 font-mono text-3xl font-bold">
                01
              </div>
              ...
              <p className="text-zinc-500 text-xs font-mono leading-relaxed">
                FastAPI validates HMAC-SHA256 signatures on{' '}
                <code>pull_request</code> events and launches asynchronous
                background tasks.
              </p>
            </div>
            ...
            <div className="p-6 bg-black border border-zinc-800 space-y-3 relative">
              ...
              <p className="text-zinc-500 text-xs font-mono leading-relaxed">
                Branches to Committer Agent if vulnerabilities are critical;
                otherwise executes reviewer routing and commit status merge
                checks.
              </p>
            </div>
            ...
            <div className="p-6 bg-black border border-zinc-800 space-y-3 relative">
              ...
              <p className="text-zinc-500 text-xs font-mono leading-relaxed">
                Writes scores, Markdown reports, and decision logs to Convex
                Cloud, instantly rendering across the TanStack dashboard.
              </p>
            </div>
          </div>
        </div>
          ...
          {faqs.map((faq, idx) => (
            <div key={idx} className="border border-zinc-800 bg-zinc-950">
              ...
              >
                <span>{faq.q}</span>
                <ChevronDown
                  className={`w-4 h-4 transition-transform ${openFaq === idx ? 'rotate-180 text-white' : 'text-zinc-500'}`}
                />
              </button>
              {openFaq === idx && (
      ...
      <section className="py-20 px-6 border-t border-zinc-900 bg-gradient-to-b from-black to-zinc-950 text-center space-y-6">
        ...
        <p className="text-zinc-400 font-mono text-xs sm:text-sm max-w-xl mx-auto">
          Install the MergeMaster GitHub App on your repositories and start
          enjoying autonomous code reviews and remediation in minutes.
        </p>
        <button
          onClick={() => requestLaunch(handleAuth)}
      ...
      <footer className="border-t border-zinc-900 px-6 py-8 text-center text-xs font-mono text-zinc-600 flex flex-col sm:flex-row items-center justify-between max-w-6xl mx-auto w-full gap-4">
        <div>
          © 2026 MergeMaster AI. Built for the{' '}
          <strong>IBM AI Builders Challenge</strong>.
        </div>
        <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-zinc-500">
          <button
            type="button"
            onClick={() => {
              setPendingAuth(() => handleAuth)
              setTermsOpen(true)
            }}
            className="hover:text-white transition-colors"
          >
            Terms & AI Data Disclosure
          </button>
          <span>//</span>
          <a
      ...
      {/* TERMS & AI DATA DISCLOSURE MODAL */}
      <TermsModal
        open={termsOpen}
